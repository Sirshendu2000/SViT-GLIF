...
parser.add_argument('-data-dir', metavar='DIR',default='/home/zhou/new_disk/Files/Sub-ImageNet2012/',
...
def update_summary(epoch, train_metrics, eval_metrics, filename, write_header=False, log_wandb=False):
    # print("write_header: ", write_header)
    ...
    try:
        for epoch in range(start_epoch, num_epochs):
            ...
            if output_dir is not None:
                update_summary(
                    epoch, train_metrics, eval_metrics, filename= os.path.join(output_dir, 'summary.csv'),
